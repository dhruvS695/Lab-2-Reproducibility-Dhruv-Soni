...
In this EDA, I am going to try to answer a few research questions:

#Changed the following two formats for the font size so that it is bolded more and is a color that can be seen as more prominent color 
<font size="5" color="red">RQ1:</font> Do Affordable Housing projects that recieve more city subsidies have more affordable units available?

<font size="5" color="red">RQ2:</font> Is there a relationship between when the project started and what kind of housing units it's made of?
